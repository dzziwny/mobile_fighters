      ...
      builder: (BuildContext context, Widget? child) {
        return Transform(
          ...
          transform: Matrix4.identity()
            ..translate(
              _translateAnimation.value.dx * widget.power,
              _translateAnimation.value.dy * widget.power,
            )
            ..rotateZ(_rotateAnimation.value * widget.power),
          // child: Opacity(
          //   opacity: _opacityAnimation.value * widget.power,
          //   child: child,
          // ),
          child: child,
        );
